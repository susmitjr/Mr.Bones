...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="belur-math-images.jpg" width="100%">
          <br>
          <h1>Belur Math</h1>
<p><b>Belur Math</b> is the head quarters of the Ramakrishna Math and Mission, founded by Swami Vivekananda. It is located on the west bank of Hoogly River, Belur, West Bengal, India and is one of the significant institutions in Kolkata. This temple is the heart of the Ramakrishna Movement. The temple is notable for its architecture that fuses Hindu, Christian and Islamic motifs as a symbol of unity of all religions. </p>
          <br>
          <div align=center>
