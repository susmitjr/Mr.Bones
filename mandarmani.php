...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="mandarmoni.png" width="100%">
          <br>
        <h1>MANDARMANI</h1>
MANDARMANI is a sea sight resort village in the state of West Bengal,India. It lies in East Midnapur district at the Northern end of the Bay of Bengal. It has a low gradient with a shallow sand beach. It is one of the large and fast developing sea sight resort village in West Bengal. It is almost 180 km from kolkata airport on the Kolkata-Digha route.<font color=red> Red crabs</font> crawling around the 13 km long beach is a special attraction of Mandarmani.<p>It is argued to be the longest derivable beach in india.However, still this beach is deposition with formation of neodunes in several areas specially around Dabanpatrabar.</p>
          <div align=center>
