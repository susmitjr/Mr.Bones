...
if(isset($_REQUEST['sub2']))
{
    ...
    IF($arr>0)
    {
        $conn=mysql_connect("localhost","root","");
    mysql_select_db("db1");
    $sql="delete from contact where uid=$arr";
        $result=mysql_query($sql,$conn);
        if($result>0)
            $msg="Successful";
        else
...
<html>
<head>
    <title>Bong Travels - Messages</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
        ...
        <tr><th>User ID</th><th>Name</th><th>Email ID</th><th>Message</th><th>Check</th></tr>
          <?php
          $arr=getallmessages();
            $i=0;
            foreach($arr as $val)
            {
                ...
                $e3=$arr[$i][2];
                $e4=$arr[$i][3];
                echo "<tr><td>$e1</td><td>$e2</td><td>$e3</td><td>$e4</td><td><input type=checkbox name=cid value=$e1></td></tr>";
                $i++;
            }
