...
<html>
<head>
    <title>Bong Travels - Admin Home</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <br>
          <h1>ADD TRIP</h1>
          <a href="addtrip.php" class="w3-btn">Go</a>
          <hr>
          <h1>UPDATE/MODIFY TRIPS</h1>
          <a href="mtrip.php" class="w3-btn">Go</a>
          <hr>
          <h1>UPDATE STATUS</h1>
          <a href="notification.php" class="w3-btn">Go</a>
          <hr>
          <h1>VIEW TRIP EARNINGS/SEATS</h1>
          <a href="earnings.php" class="w3-btn">Go</a>
          <hr>
          <h1>VIEW MESSAGES</h1>
          <a href="messages.php" class="w3-btn">Go</a>
          <br>
          <hr>
          <br>          
               </div>
