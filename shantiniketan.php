...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="Shantiniketan.jpg" width="100%">
          <br>
<h1>Shantiniketan</h1>
SHANTINIKETAN is a small town near Bolpur in the Birbhum district of West Bengal,India,approximately 160km north of Kolkata. It was established by Maharshi Debendranath Tagore,and later expanded by his son Rabindranath Tagore whose vision became what is now a university town, <FONT COLOR=BLUE>visva-bharati university</FONT> .
    <P>Shantiniketan was earlier called <FONT COLOR=BLUE>Bhubandanga</FONT> and was owned by the Tagore family.Shantiniketan became a spiritual centre where people from all religions were invited to join for meditation and prayers.He founded an ashram here in<FONT COLOR=BLUE><U><I>1863</I> </U></FONT>and became the initiator of the <FONT COLOR=BLUE><I>"Brahmo Samaj"</I></FONT>
<P>Major events:</P>
        <p>Social and Cultural events take place throughout the year. These include <FONT COLOR=BLUE>"Basanta Utsav","Barsha Mangal","Sharod Utsav","Nandan Mela","Poush Mela","Magh Utsav", "Rabindra Jayanti" </FONT> to name a few. Of these,the <FONT COLOR=BLUE>Poush mela</FONT> is a major tourist attraction.It fetches tourist, artisans, folk singers, dancers and the traditional <FONT COLOR=BLUE><U><I>"Baul"</I></U></FONT> from the neighbourhood. </p></P>
          <div align=center>
