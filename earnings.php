...
if(isset($_REQUEST['sub2']))
{
    ...
    mysql_select_db("db1");
    $tid=$_REQUEST['tid'];
    $sql="select tid,rate,capc,ppl from trip where tid='$tid'";
...
<html>
<head>
    <title>Bong Travels - Earnings</title>
<meta charset="UTF-8">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <table class="w3-table-all">
              <tr><td>Enter Table ID</td><td><select name=tid>
            ...
            <tr><td colspan="2"><input type=submit class="w3-btn" name=sub2 value="Submit"></td></tr>
              </table>
              <hr>
              <table class="w3-table-all">
              ...
              <?php
                  if(isset($_REQUEST['sub2']))
                  {
                  echo "<tr><th>Trip ID</th><th>No of seats vacant</th><th>Total amount collected</th></tr>";
              echo "<tr><td>$tid</td><td>$vac</td><td>$ttl</td></tr>";
                  }
              ?>
              </table>
