...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="bakkhali.jpg" width="100%">
          <br>
          <h1>BAKHKHALI</h1>
BAKHKHALI is seaside hamlet in Namkhana(Community Development Block) in kakdwip subdivision of South 24 Parganas district of West Bengal,India.It is located on one of the many deltaic islands spread across Southern Bengal.most of the islans are part of the sundarbans forests.This small island just out into the vast expanse of the <font color = blue><i>Bay of Bengal</font></i> .
<p>bakkhali is unique in many ways like <font color=blue><i>The frasergunj windmill,Bakhkhali Beach and Lothian Forest Islands</font></i> .one can see fishing nets spread everywhere.one can stll hear the cock crow at dawn and watch ducks puddle around muddy pools in the backyards of houses. </p>
          <br>
          <div align=center>
