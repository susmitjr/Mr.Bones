...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="dooars.jpg" width="100%">
          <br>
       <p>The <b>Dooars</b> or <b> Duars</b> are the floodplains and foothills of the eastern Himalayas in North-East India around Bhutan.Duar means 'door' in Assamese, Bengali, Nepali, Bhojpuri, and Telegu languages, and the regions forms the gateway to Bhutan from India. There are 18 passages or gateways through which the Bhutanese people can communicate with the Bhutanese people can communicate with the people living in the plains. This region is divided by the Sankosh river into the Eastern and the Western Dooars, consisting of an area of 8,800sqkmn. The western Dooars is known as the Bengal Dooars and the Eastern Dooars is known as assam Dooars. and  
</p>
          <div align=center>
