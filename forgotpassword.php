...
<html>
<head>
    <title>Bong Travels - Forgot Password</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
        ...
        <table border=2 cellpadding=4 cellspacing=4 bgcolor=#DDDDDD>
        <tr><td>Enter Username</td><td><input type=text size=50 name=uid value='<?php
                                              if(isset($_REQUEST['uid']))
                                                  echo $uid;
                                              ?>'></td></tr>
            <tr><td align=center colspan=2><input type=submit name=submit1 value="Submit"></td></tr>
       
                <div>
                <?php
                    if($sq!="")
                    {
                        echo "<tr><td>Your Question</td><td>".$sq."</td></tr>";
                        echo "<tr><td colspan=2 align=center><input type=text name=ans size=50><br></tr>
                        <tr><td colspan=2 align=center><input type=submit name=sub2 value=submit></td></tr>";
            ...
            if($msg=="1")
                {
                echo "<tr><td>Enter New Password</td><td><input type=password name=npwd size=50></td></tr>
                <tr><td colspan=2 align=center><input type=submit name=sub3 value=submit></td></tr>";
                }
                ?>
            </div>
                 </table>
