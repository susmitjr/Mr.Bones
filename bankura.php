...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="bankura-district.jpg" width="100%">
          <br>
        
          
          <h1>BANKURA</h1>
BANKURA is<FONT COLOR=BLUE>an administrative</FONT>  city and a municipality in the Burdwan district of West Bengal. It is located in the western part of the state of West Bengal. 
It is a part of <FONT COLOR=BLUE>Bardhaman</FONT>division of the state. And it is included in the area known as "Rarh" in Bengal.
	<P>The numerous place in Eastern part of Bankura start with <FONT COLOR=BLUE>Bishnupur,Joyrambati</FONT>. In western zone<font color=blue> Susunia hill,Biharinath hills</font>.At south <FONT COLOR = BLUE>Mukutmonipur and Jhilimili</FONT> and at north side<FONT COLOR=BLUE> Gandoa dam, Koro pahar and Durgapur Barrage.</FONT>FONT></P>
          <br>
          <hr>
          <br>          
               </div>
