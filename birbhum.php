...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="birbhum.jpg" width="100%">
          <br>
         <h1>BIRBHUM</h1>
BIRBHUM is an <FONT COLOR=BLUE>administrative</FONT> unit in the Indian state of West Bengal. It is the <FONT COLOR=BLUE>Northernmost district </FONT>of Burdwan division-one of the three administrative divisions of West Bengal.
The district headquaters is in <FONT COLOR=BLUE>Suri</FONT>. Often called "the land of soil".Birbhum is noted for its topography and its culturtal heritage which is unique and is somewhat different from other districts in West Bengal.
<P>The numerous fairs in Birbhum start with <FONT COLOR=BLUE>Poush Mela</FONT> at Shantiniketan and follows through the Bengali month of <FONT COLOR=BLUE>Poush</FONT> till <FONT COLOR=BLUE>Makar Sankranti</FONT>.Particularly lively is the fair at <FONT COLOR=BLUE>Jaydev Kenduli</FONT>.Birbhum has been home to <i>Kabiyals,Kirtaniyas</i> and other folk culture groups.</P>
          <br>
          <hr>
          <br>          
               </div>
