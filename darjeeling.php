...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="darjeeling-icon.jpg" width="100%">
          <br>
          <h1> DARJEELING</h1>
<p>Darjeeling is a town and a municipality in the indian state of West Bengal. It is located in the lesser Himalayas at an elevation of 6700 ft. It is noted for its <i>"tea industry"</i>. The spectacular views of "Kangchenjunga" the worlds third highest mountain.And the Darjeeling himalayan railway ,a UNESCO world heritage sight.Darjeeling is the head-quaters of darjeeling district which has a partially autonomous status within the state of West Bengal.</p>
          <br>
          <div align=center>
