...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="kalingpong.jpg" width="100%">
          <br>
          <h1>KALIMPONG</h1>
KALIMPONG is a hill station in the <font color=blue>Indian state</font> of West Bengal.It is located at an average elevation of 1250 metres.The town is set to be the headquaters of the announced <font color=blue>district of kalimpong.</font><p>The <font color=blue>Indian army's</font> 27 mountains division is located on the outskirts of the town.
It is known for its educational institutions,many of which are established during the <font color=blue>British colonial period .</p></font>It is used to be a gateway in the trade between<font color=blue> Tibet </font>and the <font color=blue>Sino-Indian War.</font>
          <br>
          <div align=center>
