...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="mirik.jpg" width="100%">
          <br>
          <h1>MIRIK</h1>
MIRIK is a picturesque tourist spot nestled in the serene hills of Darjeeling district in West Bengal India. The name Mirik comes from the lapcha word <i><font color = blue>"mir-yok"</font></i> meaning place<font color =blue><b> Burnt by Fire"</font></b> .
 <p>Mirik has become a popular tourist destination for its climate,natural beauty and easy accessibility.The center of all attractions is the Samendu lake,surrounded by garden one side and pine trees on other and linked together by an arching-food rich called <font color=blue><i>Rainbow bridge</font></i>.A 3.5 km long incircles the lake and is used for works in the view of kanchunjunga on the far horizon boating on the queint shikaras and pony riding are available. </p>
          <div align=center>
