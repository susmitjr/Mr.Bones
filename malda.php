...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <hr>
          <br>
          <img src="malda.jpg" width="100%">
          <br>
         <h1>MALDA</h1>
MALDA is a district in west Bengal,India.It lies 347 km north of Kolkata,the state capital.<font color=blue>Mango,jute and silk</font> are the most notable products of this district.The special variety of mango are produced in this region,popularly known by the name of the district,is exported across the world.
The folk culture of <font color=blue>gombhira</font> is a feature of the district,being a unique way of representation of joy and sorrow of daily life of the common people.
   <BR>some of the most reputed fairs of this district are:
<ul>
<li>Kahala urush at Mothabari</li>
<li>Kahala Durga Puja Fair</li>
<li>Ramkeli Fair</li>
<li>Gazole Fair</li>
<li>Kartik Puja Fair</li>
<li>Charak Fair</li>
</ul>
  place of interest:
<ul>
...
<li>Adina Mosque</li>
<li>Gol ghar</li>
<li>Eklakhi mosque</li>
</ol>
</ul>
<ul>
<li>Relics of Gour:</li>
</ul>
<ol>
<li>Firoz Minar</li>
<li>Chika Masjid</li>
<li>Qutwali Gate</li>
<li>Chanchal Palace</li>
<li>Pandua Shrine</li>
<li>Aquatic Bengal</li>
</ol>
          <br>
          <hr>
          <br>          
