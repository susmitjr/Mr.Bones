...
if(isset($_SESSION['un'])==false)
    ...
    mysql_select_db("db1");
    $sql="select * from booking where uid=$un";
...
<html>
<head>
    <title>Bong Travels - Bookings</title>
<meta charset="UTF-8">
...
<nav class="w3-sidenav w3-light-green w3-collapse w3-top" style="z-index:3; width:250px" id="mySidenav">
  ...
  <a href="bookings.php"  class="w3-padding w3-light-grey">Bookings</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Top header -->
      ...
      <div class="w3-content w3-display-container">
          ...
          <tr><th>Booking ID</th><th>User ID</th><th>Trip ID</th><th>Booking Date</th><th>Amount Per Head</th><th>Total Amount</th><th>No. Of People</th><th>Status</th></tr>
              <?php
              $arr=getallbookings();
              foreach($arr as $val)
              {
                  echo "<tr><td>$val[0]</td><td>$val[1]</td><td>$val[2]</td><td>$val[3]</td><td>$val[4]</td><td>$val[5]</td><td>$val[6]</td><td>$val[7]</td></tr>";
              }
              ?>
          </table>
          <br>
